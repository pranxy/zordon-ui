...
> **Design contract:** `docs/html/*.dc.html` (Get Started, Components, Button, Components Board)
...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/html/Zordon *.dc.html`                                                              | Visual contract; inline styles only; React/`dc-runtime` driven                                                                                                                | Treat as reference only; don't import `support.js` or `zd-highlight.js`                                                                                               |
