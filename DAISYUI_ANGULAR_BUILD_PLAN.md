...
| DSP-08 | Collapse      | Focus/checkbox/details/controlled modes; arrow/plus/custom indicator; force open/close; outside close; disabled; lazy/preserved content; animated size                        |  [x] |   [x] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native disclosure directives ship from `@pranxy/zordon-ui/collapse`; `<details>/<summary>` is preferred, while focus/checkbox/radio markup remains consumer-owned. Browser, SSR, accessibility, and visual evidence remains pending. Angular Aria Accordion is reserved for a separately approved grouped mode.                                                                         |
