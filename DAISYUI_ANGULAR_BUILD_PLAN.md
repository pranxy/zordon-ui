...
| DSP-05 | Card          | Figure/title/subtitle/body/actions/footer/badge slots; border/dash; side/image-full; xs–xl; responsive layout; interactive/disabled/loading/expandable states                 |  [x] |   [x] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native compound directives ship from `@pranxy/zordon-ui/card`; figure/subtitle/footer/badge and all interactive, stateful, and form behavior remain consumer-owned native composition. |
