...
| DSP-13 | Kbd           | xs–xl; single key and sequences; platform-aware labels; separators; accessible expanded names; custom symbols; active state                                                   |  [x] |   [ ] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native `<kbd>` directive is specified; platform labels, localization, separators, active state, shortcut registration, and interactivity remain consumer-owned.                                                                                                                                                                                                                         |
