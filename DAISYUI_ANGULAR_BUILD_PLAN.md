...
| DSP-07 | Chat Bubble   | Start/end; semantic colors; avatar/header/time/body/footer; delivery/read/error; grouping; media/attachments/reactions/replies; typing/loading; RTL                           |  [x] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Native compound directives: only chat/image/header/footer/bubble plus placement/color map documented classes; all message, state, media, interaction, live-update, and scrolling behavior remains consumer-owned composition. |
