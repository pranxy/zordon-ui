...
| ------ | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | ---------------------------------------------------------------------------------------------------------------------------------- |
| ACT-01 | Button           | Semantic colors; outline/dash/soft/ghost/link; xs–xl; wide/block/square/circle; active, disabled, loading; icons; native button/link/input modes; pressed and async action states        |  [x] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Maturity: Planned. Native-host API, defaults, async, a11y, styling, and evidence contract recorded in `docs/components/button.md`. |
