...
| INP-03 | Fieldset   | Native legend; label/description/help/error slots; horizontal/vertical/responsive; disabled group; required marker; summaries; nested groups                 |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                               [ ] | Native Fieldset, Legend, and Label directives ship from `@pranxy/zordon-ui/fieldset`; automated unit, browser, SSR/hydration, axe, and dark RTL mobile visual evidence is recorded. Manual AT, forced-colors, zoom/reflow, theme, and long-RTL-legend review remains pending. |
