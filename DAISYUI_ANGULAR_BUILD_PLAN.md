...
| DSP-13 | Kbd           | xs–xl; single key and sequences; platform-aware labels; separators; accessible expanded names; custom symbols; active state                                                   |  [x] |   [x] |   [x] |  [ ] |  [x] |    [ ] |  [ ] | Native `<kbd>` directive with optional typed xs–xl size is packaged; platform labels, localization, separators, active state, shortcut registration, and interactivity remain consumer-owned.                                                                                                                                                                                           |
