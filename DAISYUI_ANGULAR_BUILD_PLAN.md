...
Automated delivery progress: **43 / 68** components have verified specification, build, test,
...
| ACT-02 | Dropdown         | All placements/alignments; click/hover/focus/manual triggers; controlled state; auto-flip; outside/Escape close; focus restoration; arbitrary/menu content; nested menus; close policies |  [~] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Angular 21 Menu/CDK integration spike verified; draft contract and focus/portal/Escape findings in docs/plans/phase-5-dropdown-progress.md. Public compound API, shared stack package identity and production implementation pending. |
