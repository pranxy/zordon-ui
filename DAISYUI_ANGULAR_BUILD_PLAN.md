...
| DSP-07 | Chat Bubble   | Start/end; semantic colors; avatar/header/time/body/footer; delivery/read/error; grouping; media/attachments/reactions/replies; typing/loading; RTL                           |  [x] |   [x] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native compound directives ship from `@pranxy/zordon-ui/chat-bubble`; all message, state, media, interaction, live-update, and scrolling behavior remains consumer-owned composition. |
