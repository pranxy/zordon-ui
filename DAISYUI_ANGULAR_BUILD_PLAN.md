...
| DSP-06 | Carousel      | Horizontal/vertical; start/center/end snap; controls/dots/thumbnails; controlled index; pointer/wheel/keyboard; loop/autoplay; responsive/variable slides; lazy/virtual; RTL  |  [x] |   [x] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native scroll-snap directives ship from `@pranxy/zordon-ui/carousel`; controls, state, keyboard, looping, autoplay, virtualization, and lazy loading require separate approved behavior. Browser, SSR, accessibility, visual, and performance evidence remains pending.                                                               |
