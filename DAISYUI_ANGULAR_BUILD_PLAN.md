...
Deliver one component as a single uninterrupted milestone: finish its specification, implementation, public entry point, documentation, API report, type/unit/browser/SSR/accessibility/visual evidence, and tracker update before beginning another component. Report a commit message only after every applicable gate passes. Do not describe a component as complete while any of those tasks remain.
