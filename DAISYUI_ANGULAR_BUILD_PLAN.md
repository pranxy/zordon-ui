...
| DSP-10 | Diff          | Image/text/projected layers; controlled position; horizontal/vertical; pointer/touch/keyboard resizer; min/max/step; labels; reset                                            |  [x] |   [ ] |   [ ] |  [ ] |  [x] |    [ ] |  [ ] | Native CSS-driven compound directive scope is specified. Consumer markup owns semantics, focusability, content, and styling; controlled position, custom interaction, and other behavior require a separately approved accessible contract.                                                                                                                                             |
