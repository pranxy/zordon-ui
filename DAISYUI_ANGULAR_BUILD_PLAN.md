...
- [~] Add browser integration tests for focus, keyboard, overlays, forms, SSR, and hydration. Playwright, managed Angular serving, Chromium CI, the three-engine project matrix, and four passing boot/focus/dialog/form scenarios are configured; SSR/hydration scenarios await the SSR example.
...
- [ ] Add visual regression testing across representative daisyUI themes and breakpoints.
- [ ] Add bundle-size budgets for the primary and optional entry points.
- [ ] Add an SSR example and hydration smoke test.
- [ ] Add a release pipeline with changelog generation, prerelease channels, provenance, and dry-run publishing.
...
- [ ] Roving tabindex and typeahead utilities.
...
- [ ] Shared test harness base and interaction helpers.
...
| ACT-02 | Dropdown         | All placements/alignments; click/hover/focus/manual triggers; controlled state; auto-flip; outside/Escape close; focus restoration; arbitrary/menu content; nested menus; close policies |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Depends on overlay and menu primitives |
...
| ID     | Component     | Required feature scope                                                                                                                                                        | Spec | Build | Tests | A11y | Docs | Visual | Done | Notes                                                  |
| ------ | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | ------------------------------------------------------ |
| DSP-01 | Accordion     | Single and optional multi-open; radio/details/controlled modes; arrow/plus/custom indicators; disabled/default-open; keyboard; lazy/preserved content; deep links; nested use |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Depends on Collapse concepts                           |
...
| DSP-08 | Collapse      | Focus/checkbox/details/controlled modes; arrow/plus/custom indicator; force open/close; outside close; disabled; lazy/preserved content; animated size                        |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] |                                                        |
...
| DSP-14 | List          | Projected/data rows; leading/main/wrapping/grow/trailing parts; dividers/groups; active/disabled/selection; actions; keyboard; reorder; empty/loading; virtualization         |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Virtualization packaging decision                      |
...
| DSP-17 | Table         | Sizes/zebra/pinning; data/projected columns; sort/filter/page/select/expand/actions; sticky/resizable/reorderable columns; responsive/virtual; keyboard/caption               |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Split styled table from data table decision            |
...
| NAV-04 | Megamenu    | Anchored/full-width panels; click/hover/focus/manual; arbitrary multi-column content; Router state; menubar keyboard; delays; outside/Escape; mobile fallback  |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Depends on Menu, Dropdown, Drawer concepts |
| NAV-05 | Menu        | Vertical/horizontal; xs–xl; titles/separators/submenus; active/focus/disabled; Router; icons/badges/shortcuts; roving focus/typeahead; controlled tree; RTL    |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Core interaction dependency                |
...
| NAV-09 | Tabs        | Box/border/lift; sizes/orientations; controlled active tab; disabled/closable/reorderable; lazy/preserved panels; keyboard; activation modes; overflow; Router |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] |                                            |
...
| ID     | Component  | Required feature scope                                                                                                                                       | Spec | Build | Tests | A11y | Docs | Visual |                              Done | Notes                                                     |
| ------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---: | ----: | ----: | ---: | ---: | -----: | --------------------------------: | --------------------------------------------------------- |
| INP-01 | Calendar   | Inline/popup; single/multiple/range; min/max/disabled dates; month/year navigation; locale/week start/date adapter; custom cells; keyboard; forms; timezone  |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |                               [ ] | Own Angular implementation; optional neutral integrations |
...
| INP-10 | Select     | Colors/ghost/sizes; native single/multiple/optgroups/placeholder; disabled options; forms/validation; optional searchable async/tag/virtual advanced variant |  [ ] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |                               [ ] | Native and advanced APIs must remain distinct             |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | -----: |
| daisyUI minor releases can change internal component CSS variables                                                                                               | Pin supported versions; use public classes/tokens; add compatibility tests  |    [ ] |
...
| The current documentation app exceeds its initial bundle warning budget by 86.33 kB                                                                              | Replace legacy demo dependencies and set evidence-based budgets before beta |    [ ] |
| The current npm audit reports 31 full-workspace findings (20 high) and 8 production findings (all high), primarily fixed in Angular 21.2.19+ and PostCSS 8.5.23+ | Apply and verify non-breaking security patch upgrades without forced fixes  |    [ ] |
