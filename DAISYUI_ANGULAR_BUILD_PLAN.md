...
| DSP-09 | Countdown     | Animated 0–999 segments; digit count; count up/down; target date/duration; time units; pause/resume/reset; completion/tick; formatting/timezone; SSR timing                   |  [x] |   [x] |   [x] |  [ ] |  [x] |    [ ] |  [ ] | Native styling directive ships from `@pranxy/zordon-ui/countdown`; timer, scheduling, formatting, live announcements, visual evidence, and SSR timing require separate approved contracts.                                                                                                                                                                                              |
