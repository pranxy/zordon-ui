...
| DSP-08 | Collapse      | Focus/checkbox/details/controlled modes; arrow/plus/custom indicator; force open/close; outside close; disabled; lazy/preserved content; animated size                        |  [x] |   [ ] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Native disclosure directives map container/title/content, arrow/plus, and non-details forced-state candidates. `<details>/<summary>` is preferred; focus/checkbox/radio markup remains consumer-owned. Angular Aria Accordion is reserved for a separately approved grouped mode. |
