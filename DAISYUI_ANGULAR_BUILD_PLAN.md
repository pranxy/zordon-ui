...
| ------ | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| ACT-01 | Button           | Semantic colors; outline/dash/soft/ghost/link; xs–xl; wide/block/square/circle; active, disabled, loading; icons; native button/link/input modes; pressed and async action states        |  [x] |   [x] |   [ ] |  [ ] |  [ ] |    [ ] |  [ ] | Maturity: Planned. Native directive and typed defaults ship from `@pranxy/zordon-ui/button`; browser/SSR/a11y/visual completion remains pending. |
