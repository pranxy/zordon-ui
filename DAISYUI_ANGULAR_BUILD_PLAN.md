...
Automated delivery progress: **65 / 68** components have verified specification, build, test,
...
| ACT-06 | Theme Controller | Checkbox/toggle/radio/select/button UIs; theme registry; light/dark/system; persistence; cross-tab sync; nested scopes; SSR-safe initialization; change events                           |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Scoped native controls, registry and preference persistence verified on Angular 21. All automated checks pass; manual accessibility pending. See docs/plans/phase-5-theme-controller-progress.md.                                                                 |

### Data display — 19

| ID     | Component     | Required feature scope                                                                                                                                                        | Spec | Build | Tests | A11y | Docs | Visual | Done | Notes                                                                                                                                                                                                                                                                                                                                                                                   |
| ------ | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DSP-01 | Accordion     | Single and optional multi-open; radio/details/controlled modes; arrow/plus/custom indicators; disabled/default-open; keyboard; lazy/preserved content; deep links; nested use |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Angular Aria group/trigger/panel composition, model state, lazy preservation, native alternatives and nested component boundary verified. All automated checks pass; manual accessibility pending. See docs/plans/phase-5-accordion-progress.md and ADR 0018.                                                                                                                           |
...
| DSP-14 | List          | Projected/data rows; leading/main/wrapping/grow/trailing parts; dividers/groups; active/disabled/selection; actions; keyboard; reorder; empty/loading; virtualization         |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native compound directives ship from `@pranxy/zordon-ui/list`; automated browser, SSR, axe, and visual evidence is recorded. Plain display lists remain native; selection, keyboard, reorder, data source, and virtualization require a separately approved accessible contract, with Angular Aria Listbox reserved for an actual selectable mode.                                      |
| DSP-15 | Stat          | Title/value/description/figure/actions; groups and responsive orientation; trends; formatting; live values; delta; loading/error; chart slot                                  |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native compound Stat directives ship from `@pranxy/zordon-ui/stat`; formatting, trends, live values, loading/error, charts, and actions remain consumer-owned. Automated browser, SSR, axe, visual, and API evidence is recorded; manual contrast, forced-colors, zoom/reflow, RTL, localization, and assistive-technology review remain pending.                                       |
...
| DSP-17 | Table         | Sizes/zebra/pinning; data/projected columns; sort/filter/page/select/expand/actions; sticky/resizable/reorderable columns; responsive/virtual; keyboard/caption               |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Table directive ships from `@pranxy/zordon-ui/table`; automated browser, SSR, axe, and visual evidence is recorded. Sorting, selection, editing, data, resizing, and virtualization require a separately approved Angular Aria Grid contract.                                                                                                                                    |
| DSP-18 | Text Rotate   | Data-driven values; timing/transitions; loop/finite; pause; controlled index; controls; dynamic content; announcement policy; reduced motion                                  |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native CSS wrapper directive ships from `@pranxy/zordon-ui/text-rotate`; consumer markup owns text, timing utilities, motion and announcement policy. Timer, controls, index state, and live updates require a separately approved accessible contract.                                                                                                                                 |
| DSP-19 | Timeline      | Horizontal/vertical/compact; start/end/alternate; icons/connectors; state colors; rich content; responsive orientation; interactive events; progress semantics                |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Timeline directives ship from `@pranxy/zordon-ui/timeline`; list semantics, connectors, icon content, event behavior, progress meaning, and responsive policy remain consumer-owned. Automated browser, SSR, axe, visual, and API evidence is recorded.                                                                                                                          |

### Navigation — 9

| ID     | Component   | Required feature scope                                                                                                                                         | Spec | Build | Tests | A11y | Docs | Visual | Done | Notes                                                                                                                                                                                                                                                                 |
| ------ | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| NAV-01 | Breadcrumbs | Router links; icons; current page; separators; middle collapse; maximum items; scrolling; responsive labels; overflow dropdown; structured data                |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native navigation/RouterLink, details overflow, short visual labels, scrolling and full-trail structured data verified. All automated checks pass; manual accessibility pending. See docs/plans/phase-6-breadcrumbs-progress.md and ADR 0019.                         |
| NAV-02 | Dock        | xs–xl; icons/labels/badges; active/disabled; Router sync; keyboard; safe area; fixed/sticky; responsive visibility and overflow                                |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Router navigation, icons/badges, responsive labels/visibility, safe-area reservation and horizontal overflow verified. Automated checks pass; manual accessibility pending. See docs/plans/phase-6-dock-progress.md and ADR 0020.                              |
...
| NAV-04 | Megamenu    | Anchored/full-width panels; click/hover/focus/manual; arbitrary multi-column content; Router state; menubar keyboard; delays; outside/Escape; mobile fallback  |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Dropdown-composed native panels, Router closure, responsive grid and opt-in Aria command bar verified. Escape returns to the bar before sibling switching. Manual accessibility pending; see docs/plans/phase-6-megamenu-progress.md and ADR 0021.                    |
| NAV-05 | Menu        | Vertical/horizontal; xs–xl; titles/separators/submenus; active/focus/disabled; Router; icons/badges/shortcuts; roving focus/typeahead; controlled tree; RTL    |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native recursive navigation and Aria Tree selection verified; command menus compose Dropdown. Five sizes, Router state, model expansion, RTL and keyboard/pointer behavior pass. Manual accessibility pending; see docs/plans/phase-6-menu-progress.md.               |
| NAV-06 | Navbar      | Start/center/end slots; brand/menu/actions; sticky/fixed/static; transparent state; desktop/mobile; drawer integration; Router state; landmark semantics       |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native slots, responsive visibility, positioning and controlled panel toggle verified. Concrete Drawer pairing is verified in LYT-02; manual accessibility pending. See docs/plans/phase-6-navbar-progress.md.                                                        |
| NAV-07 | Pagination  | Page/page-size/total; first/previous/next/last; sibling/ellipsis algorithms; unknown total; loading/disabled; query-param sync; responsive; announcements      |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native controlled/Router pagination verified with bounded ranges, unknown totals, size reset, status, URL history, RTL and SSR selection. Manual accessibility pending; see docs/plans/phase-6-pagination-progress.md.                                                |
| NAV-08 | Steps       | Horizontal/vertical; colors/icons; complete/current/upcoming/error/disabled; interactive or display-only; linear mode; wizard integration; responsive          |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native ordered progress and controlled wizard requests verified, including linear completion gates, explicit states, icons/colors, responsive RTL and owner validation/focus. Manual accessibility pending; see docs/plans/phase-6-steps-progress.md.                 |
| NAV-09 | Tabs        | Box/border/lift; sizes/orientations; controlled active tab; disabled/closable/reorderable; lazy/preserved panels; keyboard; activation modes; overflow; Router |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Public Angular Aria navigation, controlled panels, close/reorder requests, native overflow and Router query selection verified, including SSR attributes and keyboard order after moving tabs. Manual accessibility pending; see docs/plans/phase-6-tabs-progress.md. |

### Feedback — 7

| ID     | Component       | Required feature scope                                                                                                                                      | Spec | Build | Tests | A11y | Docs | Visual | Done | Notes                                                                                                                                                                                                                                        |
| ------ | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FDB-01 | Alert           | Info/success/warning/error; soft/outline/dash; responsive direction; icon/title/body/actions; dismiss/auto-dismiss; details; live-region modes              |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native inline feedback, controlled dismissal and paused timers verified. All automated checks pass; manual accessibility and semantic-theme contrast pending. See docs/plans/phase-5-alert-progress.md.                                      |
| FDB-02 | Loading         | Spinner/dots/ring/ball/bars/infinity; xs–xl; colors; accessible labels; inline/center/overlay; delayed display; custom loader; reduced motion               |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Delayed native status feedback, non-blocking layouts and static motion fallbacks verified. All automated checks pass; manual accessibility and animation/theme review pending. See docs/plans/phase-5-loading-progress.md.                   |
| FDB-03 | Progress        | Determinate/indeterminate; value/max; colors; labels/formatting; optional buffer; animation; completion; reduced motion                                     |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native progress, validated values, decorative buffer, formatting and completion verified. All automated checks pass; manual accessibility and theme/motion review pending. See docs/plans/phase-5-progress-progress.md.                      |
| FDB-04 | Radial Progress | Value/max; size/thickness; colors; projected label/icon; indeterminate; animation; thresholds; reduced motion                                               |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Named progressbar, normalized ring values, projected labels/icons, size/thickness, thresholds and static motion fallbacks verified. Automated checks pass; manual accessibility pending. See docs/plans/phase-5-radial-progress-progress.md. |
| FDB-05 | Skeleton        | Text/rectangle/circle/custom; dimensions/radius; multiline and composition presets; animation/speed; loading-region semantics; reduced motion               |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Decorative shapes, multiline/composition presets, motion controls and separate busy-region semantics verified. All automated checks pass; manual accessibility pending. See docs/plans/phase-5-skeleton-progress.md.                         |
| FDB-06 | Toast           | Declarative outlet and service; all positions; semantic/custom content; timeout/pause/actions/dismiss; promise flow; queue/limit/dedupe; live priority; SSR |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native fixed outlet and local announcements per ADR 0017; queue, actions, promise flows and all positions verified. All automated checks pass; manual accessibility pending. See docs/plans/phase-5-toast-progress.md.                       |
...
| ID     | Component  | Required feature scope                                                                                                                                       | Spec | Build | Tests | A11y | Docs | Visual |                                                                                                                                                                                                                                                                                                                                                  Done | Notes                                                                                                                                                                                                                                                                                                                                                                        |
| ------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---: | ----: | ----: | ---: | ---: | -----: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| INP-01 | Calendar   | Inline/popup; single/multiple/range; min/max/disabled dates; month/year navigation; locale/week start/date adapter; custom cells; keyboard; forms; timezone  |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Angular 21.2 Calendar implemented with Aria/CDK 21.2.14; date adapter, Forms, SSR and visual evidence recorded in docs/plans/phase-4-calendar-progress.md. Automated checks complete; manual accessibility and other Angular lanes unverified.                                                                                                                               |
| INP-02 | Checkbox   | Colors; xs–xl; checked/unchecked/indeterminate; disabled/read-only; custom true/false values; labels/descriptions; groups/select-all; forms/validation       |  [x] |   [x] |   [x] |  [x] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native input directive ships colors/sizes; native HTML and Angular form accessors own checked, indeterminate, disabled, labels, validation, and serialization. Browser, SSR, axe, visual, type, and API evidence are recorded; group/select-all and consumer field composition remain separate.                                                                              |
| INP-03 | Fieldset   | Native legend; label/description/help/error slots; horizontal/vertical/responsive; disabled group; required marker; summaries; nested groups                 |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native Fieldset, Legend, and Label directives ship from `@pranxy/zordon-ui/fieldset`; automated unit, browser, SSR/hydration, axe, and light, consumer-theme, and dark RTL mobile visual evidence is recorded. Manual AT, forced-colors, zoom/reflow, theme, and long-RTL-legend review remains pending.                                                                     |
| INP-04 | File Input | Colors/sizes; single/multiple; accept/capture; drag/drop; list/remove/clear; count/size/type validation; previews; upload progress; forms                    |  [x] |   [x] |   [x] |  [x] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native input directive ships colors, sizes, and ghost styling. Browser-owned selection, `FileList`, validation, labels, submission, and security remain native; drag/drop, previews, object URLs, and uploads remain opt-in consumer composition. Browser, SSR, axe, visual, type, and API evidence is recorded.                                                             |
| INP-05 | Filter     | Radio selection and reset; styles/sizes; controlled state; disabled; icons/counts; data options; Router/query sync; keyboard; responsive overflow            |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native Filter container, item, and reset directives ship from `@pranxy/zordon-ui/filter`. Native controls own selection, reset, keyboard, Forms, validation, and serialization; controlled values, router sync, data, icons/counts, and responsive overflow remain consumer-owned. Automated browser, SSR, axe, and visual evidence is recorded; manual review remains open. |
...
| INP-07 | Radio      | Colors; xs–xl; group value; disabled/read-only; layouts; descriptions/custom options; arrow-key navigation; forms/validation                                 |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native radio directive ships colors and sizes. Same-name inputs keep browser-owned selection, arrow navigation, validation, form serialization, labels, descriptions, and layout; `readonly` is unsupported for native radios. Browser, SSR, axe, visual, type, and API evidence is recorded; manual AT and display-mode review remains open.                                |
| INP-08 | Range      | Colors/sizes; min/max/step; marks/ticks/labels; value tooltip; vertical/RTL; keyboard; formatting; discrete/continuous; optional dual thumb; forms           |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |          Native Range directive ships colors, sizes, and vertical styling. Native input owns values, bounds, keyboard, Forms, validation, and serialization; marks, labels, formatting, tooltips, and dual-thumb controls remain consumer-owned. Automated browser, SSR, axe, visual, type, and API evidence is recorded; manual review remains open. |
| INP-09 | Rating     | Custom maximum; whole/half; masks/colors/sizes; clear; hover preview; controlled/read-only/disabled; keyboard; custom icons; forms                           |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native Rating and Rating Hidden directives ship from `@pranxy/zordon-ui/rating`. Native radios own selection, keyboard, Forms, validation, labels, and serialization; option count, masks, colors, half composition, hover preview, formatting, and read-only policy remain consumer-owned. Automated evidence is recorded; manual review remains open.                      |
| INP-10 | Select     | Colors/ghost/sizes; native single/multiple/optgroups/placeholder; disabled options; forms/validation; optional searchable async/tag/virtual advanced variant |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] | Native Select directive ships colors, sizes, and ghost styling. Native select owns selection, options, optgroups, keyboard, Forms, validation, and serialization; searchable, async, tagging, and virtualized choices remain a distinct Aria Combobox/Listbox plus CDK Overlay component. Automated evidence is recorded; manual review remains open. |
...
| INP-15 | OTP        | Configurable length/character set; visual cells; input strategy; auto-advance/backspace; paste/autofill; masking; states; validation; completion; forms      |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                                                                                                                                                                                                                                                                                                   [ ] | Native OTP component provides labelled cells, paste distribution, keyboard focus movement, completion, and Reactive Forms adaptation. Automated evidence is recorded; mobile, password-manager, and manual accessibility review remain open.                                                                                                                                 |
...
| LYT-02 | Drawer    | Start/end; controlled state; responsive persistent/modal/push modes; backdrop/Escape; focus/scroll; widths; swipe; nesting; route close; safe areas |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Shared Modal composition, native inline layouts, Navbar pairing, Router close, swipe, nested focus/scroll and responsive SSR verified. Manual accessibility pending. See docs/plans/phase-6-drawer-progress.md.                                                                                                                                         |
| LYT-03 | Footer    | Responsive direction; centered variant; brand/link groups/social/newsletter/legal slots; collapsible mobile groups; theme scope; landmark           |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Footer and Footer Title directives ship from `@pranxy/zordon-ui/footer`; landmark, navigation, forms, responsive policy, content, and interaction remain consumer-owned. Automated browser, SSR, axe, visual, and API evidence is recorded.                                                                                                      |
| LYT-04 | Hero      | Media/background/overlay/content; centered/side layouts; responsive reversal; height; image/video; title/body/actions; loading; heading semantics   |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Hero, Content, and Overlay directives ship from `@pranxy/zordon-ui/hero`; semantic host, media, headings, order, actions, motion, and behavior remain consumer-owned. Automated browser, SSR, axe, visual, and API evidence is recorded.                                                                                                         |
| LYT-05 | Indicator | All logical placements; multiple indicators; offsets; badge/status/arbitrary content; responsive placement; conditional visibility; RTL             |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Indicator and Indicator Item directives expose daisyUI’s logical placement classes; semantics, item content, visibility, offsets, responsive policy, and behavior remain consumer-owned. Automated browser, SSR, axe, visual, and API evidence is recorded.                                                                                      |
| LYT-06 | Join      | Horizontal/vertical/responsive; automatic radii; arbitrary items; segmented behavior; optional keyboard; disabled; equal width; wrapping            |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Join and Join Item directives ship as a styling-only composition; child semantics, behavior, equal-width, wrapping, and keyboard policy remain consumer-owned. Automated browser, axe, visual, and API evidence is recorded.                                                                                                                     |
| LYT-07 | Mask      | All daisyUI shapes; image/projected content; sizing/object fit; custom CSS mask; accessible image handling; unsupported fallback                    |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native Mask directive ships exact daisyUI shape and half-mask candidates. Image/content semantics, sizing, fallback, and custom styling remain consumer-owned. Automated browser, SSR, axe, visual, type, and API evidence is recorded; manual image-alternative, forced-colors, contrast, zoom/reflow, and assistive-technology review remain pending. |
| LYT-08 | Stack     | Layered items; alignment/offset/depth/count; active layer; next/previous; click/drag; z-order; animations; static/reduced-motion modes              |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |  [ ] | Native CSS-only Stack directive ships from `@pranxy/zordon-ui/stack`; consumer markup owns semantics, dimensions, content, z-order, interaction, and motion. Automated browser, SSR, axe, visual, and API evidence is recorded.                                                                                                                         |

### Mockups — 4

| ID     | Component      | Required feature scope                                                                                                                         | Spec | Build | Tests | A11y | Docs | Visual |                                                                         Done | Notes                                                                                                                                                                                                                                                                                                                                                                    |
| ------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---: | ----: | ----: | ---: | ---: | -----: | ---------------------------------------------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| MCK-01 | Browser Mockup | Chrome/content slots; URL/title; controls; themes; responsive sizing; loading/screenshot/content modes; visual overrides                       |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                          [ ] | Native Browser Mockup and Toolbar directives apply styling only. Host semantics, accessible naming, controls, preview content, responsive policy, and visual overrides remain consumer-owned. Automated browser, SSR, axe, visual, type, and API evidence is recorded; manual contrast, forced-colors, zoom/reflow, RTL, and assistive-technology review remain pending. |
| MCK-02 | Code Mockup    | Lines; prompts/numbers; highlighted/error/success rows; title/actions; copy; language label; highlighting integration; overflow; copy feedback |  [x] |   [x] |   [x] |  [~] |  [x] |    [x] |                                                                          [ ] | Native Code Mockup applies styling only. Code semantics, line prefixes, highlighting, language metadata, copy controls, feedback, overflow policy, and custom styling remain consumer-owned. Automated browser, SSR, axe, visual, type, and API evidence is recorded; manual contrast, forced-colors, zoom/reflow, RTL, and assistive-technology review remain pending.  |
...
- [x] Correct native pointer-focus assumptions and verify the ten affected scenarios in all
      three engines. See [native focus compatibility](docs/plans/phase-8-native-focus-progress.md).
- [x] Verify the local desktop matrix with native keyboard-policy and Progress paint assertions.
...
- [x] Minimum supported Angular version: 21.0.0 packaged consumer.
- [x] Latest supported Angular version: 22.1.7 packaged consumer.
...
| 2026-09-20 | Added Pagination controlled buttons and Router query links with bounded ranges, page-size reset, unknown totals, loading/disabled state and status announcements. All automated checks pass, including no-JavaScript links and selected size; delivery is 62/68. Manual accessibility remains pending.                                                                           | Phase 6 implementation  | `docs/plans/phase-6-pagination-progress.md`             |
| 2026-09-20 | Added Navbar native navigation with start/center/end slots, responsive content, positioning, transparent surfaces and controlled external-panel toggle. Full automated checks pass; delivery is 61/68. Concrete Drawer pairing follows in LYT-02; manual accessibility remains pending.                                                                                          | Phase 6 implementation  | `docs/plans/phase-6-navbar-progress.md`                 |
| 2026-09-20 | Added Menu native navigation and Aria Tree hierarchies with Router state, titles/separators, decorations, five sizes, orientation and model-driven expansion/selection. All automated checks pass; delivery is 60/68. Manual accessibility remains pending.                                                                                                                      | Phase 6 implementation  | `docs/plans/phase-6-menu-progress.md`                   |
| 2026-09-20 | Added Megamenu with shared Dropdown behavior, native Router navigation, responsive wide panels and opt-in Aria command bar. Automated checks pass; delivery is 59/68. Manual accessibility remains pending.                                                                                                                                                                      | Phase 6 implementation  | `docs/plans/phase-6-megamenu-progress.md`               |
| 2026-09-20 | Added Dock with native Router navigation, manual current-page state, icons/badges, five sizes, safe-area reservation, fixed/sticky/static placement and responsive visibility/overflow. All automated checks pass; delivery is 58/68. Manual accessibility remains pending.                                                                                                      | Phase 6 implementation  | `docs/plans/phase-6-dock-progress.md`                   |
| 2026-09-20 | Started Phase 6 with Breadcrumbs: native navigation and RouterLink, current-page semantics, responsive labels, bounded middle disclosure, scrolling and explicit canonical structured data. All automated checks pass; delivery is 57/68. Manual accessibility remains pending.                                                                                                  | Phase 6 implementation  | `docs/plans/phase-6-breadcrumbs-progress.md`            |
| 2026-09-19 | Added Accordion using Angular Aria with single/multiple expansion, native headings/buttons, model state, lazy preservation, indicators, native alternatives and nested component isolation. All automated checks pass; delivery is 56/68. Manual accessibility remains pending.                                                                                                  | Phase 5 implementation  | `docs/plans/phase-5-accordion-progress.md`              |
| 2026-09-19 | Added Toast service and outlet with nine positions, queue limits/deduplication, timeout pause, actions, promise flows and local announcement priority. All automated checks pass; delivery is 55/68. Manual accessibility remains pending.                                                                                                                                       | Phase 5 implementation  | `docs/plans/phase-5-toast-progress.md`                  |
| 2026-09-19 | Added Skeleton shapes, dimensions/clipping, multiline and composition presets, shimmer/pulse/static modes and a separate busy-region directive. All automated checks pass; delivery is 54/68. Manual accessibility remains pending.                                                                                                                                              | Phase 5 implementation  | `docs/plans/phase-5-skeleton-progress.md`               |
| 2026-09-19 | Added Radial Progress with named progressbar semantics, normalized values, custom dimensions, projected content, percentage thresholds and motion fallbacks. All automated checks pass; delivery is 53/68. Manual accessibility remains pending.                                                                                                                                 | Phase 5 implementation  | `docs/plans/phase-5-radial-progress-progress.md`        |
| 2026-09-19 | Added Progress with native determinate/indeterminate semantics, clamped values/buffer, formatted labels, completion and motion controls. Automated delivery is 52/68; manual accessibility remains pending.                                                                                                                                                                      | Phase 5 implementation  | `docs/plans/phase-5-progress-progress.md`               |
| 2026-09-19 | Added Loading with six animation families, sizes/colors, delayed status text, custom artwork and non-blocking layouts. Static reduced-motion/forced-color fallbacks, browser, SSR, coverage and package checks pass; delivery is 51/68. Manual accessibility remains pending.                                                                                                    | Phase 5 implementation  | `docs/plans/phase-5-loading-progress.md`                |
| 2026-09-18 | Added Alert with semantic styles, native projected content/details/actions, explicit live modes, controlled dismissal and opt-in paused timers. Full automated checks pass; delivery is 50/68. Manual accessibility and theme contrast remain pending.                                                                                                                           | Phase 5 implementation  | `docs/plans/phase-5-alert-progress.md`                  |
| 2026-09-18 | Added Theme Controller with scoped native controls, custom registries, system preference, optional persistence and cross-tab synchronization. Browser, SSR, visual, coverage and package checks pass; automated delivery is 49/68. Manual accessibility remains pending.                                                                                                         | Phase 5 implementation  | `docs/plans/phase-5-theme-controller-progress.md`       |
...
| 2026-09-14 | Added Calendar on Angular 21.2 with Aria/CDK 21.2.14: date adapter, single/multiple/range selection, Forms, localization, keyboard and popup behavior. Unit, type, API, package, Chromium, SSR and visual checks pass; automated delivery is 43/68. Manual accessibility and other Angular lanes remain unverified. Also repaired OTP input filtering and its verification gaps. | Phase 4 implementation  | `docs/plans/phase-4-calendar-progress.md`               |
| 2026-09-07 | Added the native Radio secondary entry point with typed colors and sizes. Same-name native inputs retain group selection, arrow-key navigation, Forms integration, validation, and serialization; unit/type/API/package, Chromium, SSR/hydration, axe, and dark RTL mobile visual evidence is recorded. Manual assistive-technology and display-mode review remains open.        | Phase 4 implementation  | `projects/components/radio/`, `docs/components/`        |
| 2026-09-07 | Added Fieldset native disabled-group, first-legend exemption, nested-group, and consumer help/error relationship proof; packaged manual review records; and recorded dark RTL mobile, light desktop, and consumer-theme desktop visual baselines. Fieldset remains Planned until its manual AT and display-mode review is complete.                                              | Phase 3 implementation  | `projects/components/fieldset/`, `docs/components/`     |
| 2026-09-06 | Added native Browser Mockup and Browser Mockup Toolbar secondary entry points. The styling-only directives preserve consumer ownership of host semantics, accessible name, URL/title display, controls, preview content, responsive policy, and visual customisation; unit/type/API/package, Chromium, SSR/hydration, axe, and dark RTL mobile visual evidence is recorded.      | Phase 3 implementation  | `projects/components/browser-mockup/`                   |
| 2026-09-06 | Added the native Mask secondary entry point with exact daisyUI shape and half-mask candidates. Consumer markup retains image/content semantics, alternative text, fallback, sizing, object fit, and custom styling; unit/type/API/package, Chromium, SSR/hydration, axe, and dark RTL mobile visual evidence is recorded.                                                        | Phase 3 implementation  | `projects/components/mask/`                             |
| 2026-09-06 | Added the native Indicator and Indicator Item secondary entry point with exact logical placement candidates, unit/type/API/package validation, a Chromium semantic and axe check, SSR/hydration proof, and a dark RTL mobile visual baseline. Consumer markup owns semantics, content, offsets, visibility, responsive policy, and behavior.                                     | Phase 3 implementation  | `projects/components/indicator/`                        |
