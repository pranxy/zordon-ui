...
| NAV-03 | Link        | Semantic colors; hover underline; native and Router links; external/download; disabled; current route; icons; new-window indication                            |  [x] |   [x] |   [~] |  [ ] |  [x] |    [ ] |  [ ] | Native anchor directive; Router/current-route and external/new-window semantics remain consumer-owned. |
