...
const routeMatrix = [
  ...
  { path: '/components/fab', heading: 'FAB / Speed Dial', status: 200 },
  { path: '/components/modal', heading: 'Modal', status: 200 },
  { path: '/components/theme-controller', heading: 'Theme Controller', status: 200 },
  { path: '/components/swap', heading: 'Swap', status: 200 },
  { path: '/components/accordion', heading: 'Accordion', status: 200 },
  { path: '/components/avatar', heading: 'Avatar', status: 200 },
  { path: '/components/aura', heading: 'Aura', status: 200 },
  { path: '/components/badge', heading: 'Badge', status: 200 },
  { path: '/components/card', heading: 'Card', status: 200 },
  { path: '/components/chat-bubble', heading: 'Chat Bubble', status: 200 },
  { path: '/components/countdown', heading: 'Countdown', status: 200 },
  { path: '/components/diff', heading: 'Diff', status: 200 },
  { path: '/components/hover-3d', heading: 'Hover 3D Card', status: 200 },
  { path: '/components/hover-gallery', heading: 'Hover Gallery', status: 200 },
  { path: '/components/list', heading: 'List', status: 200 },
  { path: '/components/stat', heading: 'Stat', status: 200 },
  { path: '/components/status', heading: 'Status', status: 200 },
  { path: '/components/table', heading: 'Table', status: 200 },
  { path: '/components/text-rotate', heading: 'Text Rotate', status: 200 },
  { path: '/components/timeline', heading: 'Timeline', status: 200 },
  { path: '/components/divider', heading: 'Divider', status: 200 },
  { path: '/components/drawer', heading: 'Drawer', status: 200 },
  { path: '/components/footer', heading: 'Footer', status: 200 },
  { path: '/components/hero', heading: 'Hero', status: 200 },
  { path: '/components/indicator', heading: 'Indicator', status: 200 },
  ...
  { path: '/components/dock', heading: 'Dock', status: 200 },
  { path: '/components/link', heading: 'Link', status: 200 },
  { path: '/components/navbar', heading: 'Navbar', status: 200 },
  { path: '/components/pagination', heading: 'Pagination', status: 200 },
  { path: '/components/steps', heading: 'Steps', status: 200 },
  { path: '/components/tabs', heading: 'Tabs', status: 200 },
  ...
  { path: '/components/checkbox', heading: 'Checkbox', status: 200 },
  { path: '/components/radio', heading: 'Radio', status: 200 },
  { path: '/components/range', heading: 'Range', status: 200 },
  { path: '/components/rating', heading: 'Rating', status: 200 },
  { path: '/components/select', heading: 'Select', status: 200 },
  ...
  { path: '/components/alert', heading: 'Alert', status: 200 },
  { path: '/components/loading', heading: 'Loading', status: 200 },
  { path: '/components/progress', heading: 'Progress', status: 200 },
  { path: '/components/radial-progress', heading: 'Radial Progress', status: 200 },
  { path: '/components/skeleton', heading: 'Skeleton', status: 200 },
  { path: '/components/toast', heading: 'Toast', status: 200 },
  { path: '/components/tooltip', heading: 'Tooltip', status: 200 },
