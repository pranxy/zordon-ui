...
test('commits the generated primary API report and exposes check/update scripts', async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      'api-extractor-hero.json',
      'api-extractor-indicator.json',
      'api-extractor-join.json',
      'api-extractor-mask.json',
      'api-extractor-browser-mockup.json',
      'api-extractor-code-mockup.json',
      'api-extractor-checkbox.json',
      'api-extractor-file-input.json',
      'api-extractor-filter.json',
      'api-extractor-radio.json',
      'api-extractor-range.json',
      'api-extractor-rating.json',
