...
| T06 | Add browser, SSR/hydration, axe, and visual evidence                       | T05     | Pending  | Native layout semantics survive supported render paths                        |
...
- Add browser, SSR/hydration, axe, and visual evidence for the native layout. Controlled navigation, keyboard, looping, autoplay, and virtualization require a separate approved interaction phase.
