...
| T05 | Package the Chat Bubble directives                                         | T04     | Pending  | Public entry point builds with the reviewed candidate surface                                                                        | Unit/type/API/tooling/bundle/tarball checks           |
...
- Implement the five Chat Bubble directives and their intentional `./chat-bubble` secondary entry point.
