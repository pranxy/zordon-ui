...
@Component({
  selector: 'docs-theme-host-fixture',
...
@Component({
  ...
  styleUrls: [
    './range-fixture.css',
    './aura-fixture.css',
    './carousel-fixture.css',
    './collapse-fixture.css',
  ],
  host: {
...
Initial release note</textarea>
      ...
      <section
        aria-labelledby="hover-gallery-heading"
        class="grid gap-3"
        data-testid="hover-gallery-contract"
      >
        <h2 id="hover-gallery-heading" class="text-xl font-semibold">
          Native Hover Gallery behavior
        </h2>
        <figure zdHoverGallery class="w-60" data-testid="hover-gallery-example">
          <img
      ...
      <section aria-labelledby="hero-heading" class="grid gap-3" data-testid="hero-contract">
        <h2 id="hero-heading" class="text-xl font-semibold">Native Hero behavior</h2>
        <section
          zdHero
      ...
      <section
        aria-labelledby="indicator-heading"
        class="grid gap-3"
        data-testid="indicator-contract"
      >
        <h2 id="indicator-heading" class="text-xl font-semibold">Native Indicator behavior</h2>
      ...
      <div data-testid="async-action-contract">
        ...
        @if (asyncProbeVisible()) {
          <docs-async-action-probe (cleanup)="asyncCleanupAborts.set($event)" />
        }
      </div>
      ...
      <section hidden data-testid="theme-contract" zdTheme="corporate">
        ...
        <docs-theme-host-fixture data-testid="component-theme" zdTheme="zordon-visual" />
