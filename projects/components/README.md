...
Stable generated relationships and their SSR/hydration boundaries are documented in the
[stable ID contract](https://github.com/pranxy/zordon-ui/blob/master/docs/foundations/stable-ids.md).
