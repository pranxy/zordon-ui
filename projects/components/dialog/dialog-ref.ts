...
import { DialogPosition, ZdDialogConfig } from './dialog-config';
...
export class ZdDialogRef<T, R = any> {
    ...
    constructor(
        ...
        private _config: ZdDialogConfig,
        public _containerInstance: ZdDialogContainer
    ) {
...
export function _closeDialogVia<R>(ref: ZdDialogRef<R>, interactionType: FocusOrigin, result?: R) {
