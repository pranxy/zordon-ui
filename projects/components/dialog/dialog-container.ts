...
const OPEN_CLASS = 'z-dialog--open';

/** Class added while the dialog is opening. */
const OPENING_CLASS = 'z-dialog--opening';

/** Class added while the dialog is closing. */
const CLOSING_CLASS = 'z-dialog--closing';
...
@Component({
    ...
    host: {
        'class': 'z-dialog-container modal modal-open',
        'tabindex': '-1',
...
export class ZdDialogContainer extends CdkDialogContainer<ZdDialogConfig> implements OnDestroy {
