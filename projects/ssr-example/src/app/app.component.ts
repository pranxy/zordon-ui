  ...
  template: `
    <main>
      ...
      <section [attr.aria-labelledby]="interactionHeadingId">
        ...
        <section aria-labelledby="rating-heading" data-testid="rating-contract">
          <h2 id="rating-heading">Hydrated native Rating</h2>
          <fieldset>
...
Initial release note</textarea>
        ...
        <section aria-labelledby="otp-heading" data-testid="otp-contract">
          <h2 id="otp-heading">Hydrated one-time password</h2>
